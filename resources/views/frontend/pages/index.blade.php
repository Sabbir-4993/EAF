...
@section('content')
    <section class="block-preview">
        <div class="cover-banner" style="background-image: url({{asset('frontend/images/homepage/banner.jpg')}})"></div>
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="banner">
                        <div class="ads-banner" style="background-image: url({{asset('frontend/images/homepage/offer-banners/banner-1.jpg')}})"></div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="banner">
                        <div class="ads-banner" style="background-image: url({{asset('frontend/images/homepage/offer-banners/banner-2.jpg')}})"></div>
                        <div class="banner-items">
                            <div class="bnnr-text">
    ...
    <section class="pocket-block-preview">
        <div class="pocket-cover-banner" style="background-image: url({{asset('frontend/images/homepage/bottom-banner.jpg')}})"></div>
        <div class="container">
            <div class="row">

...
@section('content')
    ...
    <section class="my-account">
        <div class="profile-bg">
            <img src="{{asset('frontend/images/profile/bg-img.jpg')}}" alt="Responsive image">
            <div class="my-Profile-dt">
                <div class="container">
                    <div class="row">
                        <div class="container">
                            <div class="profile-dpt">
                                <img src="{{asset('frontend/images/profile/dp-1.jpg')}}" alt="">
                                <img src="{{asset('frontend/images/profile/dp-1.jpg')}}" alt="">
                            </div>
                            <div class="profile-all-dt">
                                ...
                                <div class="profile-dt">
                                    <ul>
                                        <li>
                                            <a href="setting.html" class="setting-btn btn-link"><span><i
                                                        class="fas fa-cog"></i></span>Setting</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="col-lg-3 col-md-4 col-12">
                    <div class="left-tab-links">
                        <div class="nav nav-pills nav-stacked nav-tabs ui vertical menu fluid">
                            ...
                            <a href="#notifications" data-toggle="tab" class="item user-tab cursor-pointer">Notifications
                                <span class="n-badge">2</span></a>
                            <a href="#photos" data-toggle="tab" class="item user-tab cursor-pointer" id="bookmarks"
                               data-tab="bookmarks">Photos</a>
                            ...
                            <a href="#recently-viewed-restaurants" data-toggle="tab" class="item user-tab cursor-pointer">Recently
                                Viewed Restaurants</a>
                            ...
                            <a href="#order-history" data-toggle="tab" class="item user-tab cursor-pointer">Order
                                History</a>
                            <a href="#my-videos" data-toggle="tab" class="item user-tab cursor-pointer">My Videos</a>
                            <a href="#recently-watch" data-toggle="tab" class="item user-tab cursor-pointer">Recently
                                Watch</a>
                            <a href="#manage-cards" data-toggle="tab" class="item user-tab cursor-pointer">Manage Cards</a>
                            <a href="#manage-wallets" data-toggle="tab" class="item user-tab cursor-pointer">Manage
                                Wallets</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="tab-pane active" id="timeline">
                            <div class="timeline">
                                ...
                                <div class="main-comments">
                                    <div class="rating-1">
                                        <div class="user-detail-heading">
                                            <a href="user_profile_view.html"><img src="{{asset('frontend/images/recipe-details/comment-5.png') }}"
                                                                                  alt=""></a>
                                            <h4> Joy Cutler</h4><br>
                                            <div class="rate-star">
                                    ...
                                    <div class="review-tags">
                                        <p>
                                            <ins>Tags :</ins>
                                            <a href="#">Johnson,</a> <a href="#"> Jasica,</a><a href="#"> Joy William,</a>
                                            <a href="#"> Johnson,</a><a href="#"> Jass Singh,</a>&nbsp; <span> and</span>&nbsp;
                                            <a href="#">8 others</a></p>
                                    </div>
                                        ...
                                        <div class="select-images">
                                            <ul>
                                                <li class="image-select">
                                                    <img src="{{asset('frontend/images/restaurant-detail/add-1.jpg')}}" alt="">
                                                </li>
                                                <li class="image-select">
                                                    <img src="{{asset('frontend/images/restaurant-detail/add-2.jpg')}}" alt="">
                                                </li>
                                                <li class="image-select">
                                                    <img src="{{asset('frontend/images/restaurant-detail/add-3.jpg')}}" alt="">
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="reply-comment">
                                        <div class="post-items">
                                            ...
                                            <form>
                                                <input type="text" class="comment-input-1" name="post"
                                                       placeholder="Write a comment - @tag friends">
                                ...
                                <div class="main-comments">
                                    <div class="rating-1">
                                        <div class="user-detail-heading">
                                            <a href="user_profile_view.html"><img src="{{asset('frontend/images/recipe-details/comment-2.png') }}"
                                                                                  alt=""></a>
                                        ...
                                        <div class="comment-description">
                                            <p>Duis posuere justo neque, sit amet efficitur quam aliquam non. Integer
                                                gravida ex quis lacinia consectetur.</p>
                                        </div>
                                    </div>
                                    <div class="review-tags">
                                        <p>
                                            <ins>Tags :</ins>
                                            <a href="#">Johnson,</a> <a href="#"> Rock Hunter,</a> <a href="#"> Joy
                                                William,</a> <a href="#"> Johnson,</a><a href="#"> Jass Singh,</a>&nbsp; <span> and</span>&nbsp;
                                            <a href="#">8 others</a></p>
                                    </div>
                                    <div class="like-comment-dt">
                                        <ul>
                                ...
                                <div class="main-comments">
                                    <div class="rating-1">
                                        <div class="user-detail-heading">
                                            <a href="user_profile_view.html"><img src="{{asset('frontend/images/recipe-details/comment-1.png') }}"
                                                                                  alt=""></a>
                                            <h4> John Doe</h4><br>
                                            <div class="rate-star">
                                                <i class="fas fa-star"></i>
                                                        ...
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div>
                                                                        <iframe height="450"
                                                                                src="https://www.youtube.com/embed/6CFJhTKcGJ4"
                                            ...
                                            <li>
                                                <div class="dp-detail">
                                                    ...
                                                    <p><a href="https://gambolthemes.net/cdn-cgi/l/email-protection"
                                                          class="__cf_email__"
                                                          data-cfemail="2e644146404a414b6e49434f4742004d4143">[email&#160;protected]</a>
                                                    </p>
                                                </div>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <div class="dp-detail">
                                                    ...
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur
                                                        elementum leo sit amet volutpat porta. Integer tincidunt id enim
                                                        eget suscipit. Aenean vitae mi at arcu pulvinar dictum. Donec
                                                        pretium ipsum diam, vitae posuere nunc dapibus ut. Vivamus tempus et
                                                        magna at elementum</p>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="dp-detail">
                                                    ...
                                                    <div class="my-social-links">
                                                        <a href="#" class="socail-btn-link f-btn"><i
                                                                class="fab fa-facebook-f"></i></a>
                                                        <a href="#" class="socail-btn-link t-btn"><i
                                                                class="fab fa-twitter"></i></a>
                                                        <a href="#" class="socail-btn-link g-btn"><i
                                                                class="fab fa-google"></i></a>
                                                        <a href="#" class="socail-btn-link i-btn"><i
                                                                class="fab fa-instagram"></i></a>
                                                        <a href="#" class="socail-btn-link y-btn"><i
                                    ...
                                    <div class="noti-bg">
                                        <ul>
                                            <li>
                                                <div class="n-media">
                                                    <div class="n-media-left">
                                                        <img src="{{asset('frontend/images/profile/noti-1.png') }}" alt="">
                                                    </div>
                                            ...
                                            <li>
                                                <div class="n-media">
                                                    <div class="n-media-left">
                                                        <img src="{{asset('frontend/images/profile/noti-2.png') }}" alt="">
                                                    </div>
                                                    <div class="media-body">
                                                        <h4 class="media-heading">
                                                            Johnson Smith
                                            ...
                                            <li>
                                                <div class="n-media">
                                                    <div class="n-media-left">
                                                        <img src="{{asset('frontend/images/profile/noti-3.png') }}" alt="">
                                                    </div>
                                                    <div class="media-body">
                                                        <h4 class="media-heading">
                                                            Rock Hunter
                                            ...
                                            <li>
                                                <div class="n-media">
                                                    <div class="n-media-left">
                                                        <img src="{{asset('frontend/images/profile/noti-4.png') }}" alt="">
                                                    </div>
                                                    <div class="media-body">
                                                        <h4 class="media-heading">
                                                            Jassica William
                                            ...
                                            <li>
                                                <div class="n-media">
                                                    <div class="n-media-left">
                                                        <img src="{{asset('frontend/images/profile/noti-5.png') }}" alt="">
                                                    </div>
                                                    <div class="media-body">
                                                        <h4 class="media-heading">
                                                            Joy Smith
                                            ...
                                            <li>
                                                <div class="n-media">
                                                    <div class="n-media-left">
                                                        <img src="{{asset('frontend/images/profile/noti-6.png') }}" alt="">
                                                    </div>
                                                    <div class="media-body">
                                                        <h4 class="media-heading">
                                                            Order Request
                                            ...
                                            <li>
                                                <div class="n-media">
                                                    <div class="n-media-left">
                                                        <img src="{{asset('frontend/images/profile/noti-7.png') }}" alt="">
                                                    </div>
                                                    <div class="media-body">
                                                        <h4 class="media-heading">
                                                            Congratulations!
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                                    <div class="photo-gallery">
                                                        <img src="{{asset('frontend/images/restaurant-detail/photo-1.jpg')}}" alt="">
                                                        <a href="#"><i class="far fa-plus-square"></i></a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                                    <div class="photo-gallery">
                                                        <img src="{{asset('frontend/images/restaurant-detail/photo-2.jpg')}}" alt="">
                                                        <a href="#"><i class="far fa-plus-square"></i></a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                                    <div class="photo-gallery">
                                                        <img src="{{asset('frontend/images/restaurant-detail/photo-3.jpg')}}" alt="">
                                                        <a href="#"><i class="far fa-plus-square"></i></a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                                    <div class="photo-gallery">
                                                        <img src="{{asset('frontend/images/restaurant-detail/photo-4.jpg')}}" alt="">
                                                        <a href="#"><i class="far fa-plus-square"></i></a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                                    <div class="photo-gallery">
                                                        <img src="{{asset('frontend/images/restaurant-detail/photo-5.jpg')}}" alt="">
                                                        <a href="#"><i class="far fa-plus-square"></i></a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                                    <div class="photo-gallery">
                                                        <img src="{{asset('frontend/images/restaurant-detail/photo-6.jpg')}}" alt="">
                                                        <a href="#"><i class="far fa-plus-square"></i></a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                                    <div class="photo-gallery">
                                                        <img src="{{asset('frontend/images/restaurant-detail/photo-7.jpg')}}" alt="">
                                                        <a href="#"><i class="far fa-plus-square"></i></a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                                    <div class="photo-gallery">
                                                        <img src="{{asset('frontend/images/restaurant-detail/photo-8.jpg')}}" alt="">
                                                        <a href="#"><i class="far fa-plus-square"></i></a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                        ...
                                        <ul>
                                            <li>
                                                <div class="suggestion-usd-2">
                                                    <a href="user_profile_view.html"><img src="{{asset('frontend/images/profile/noti-1.png') }}"
                                                                                          alt=""></a>
                                                    <div class="sgt-text-2">
                                                        <a href="user_profile_view.html"><h4>Jassica William</h4></a>
                                                        <p><span><i class="fas fa-map-marker-alt"></i></span> Sydney,
                                                            Australia
                                                        <p>
                                                    </div>
                                            ...
                                            <li>
                                                <div class="suggestion-usd-2">
                                                    <a href="user_profile_view.html"><img src="{{asset('frontend/images/profile/noti-2.png') }}"
                                                                                          alt=""></a>
                                                    <div class="sgt-text-2">
                                            ...
                                            <li>
                                                <div class="suggestion-usd-2">
                                                    <a href="user_profile_view.html"><img src="{{asset('frontend/images/profile/noti-3.png') }}"
                                                                                          alt=""></a>
                                                    <div class="sgt-text-2">
                                            ...
                                            <li>
                                                <div class="suggestion-usd-2">
                                                    <a href="user_profile_view.html"><img src="{{asset('frontend/images/profile/noti-5.png') }}"
                                                                                          alt=""></a>
                                                    <div class="sgt-text-2">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-12 pm-right">
                                                    <div class="visit-restaurants">
                                                        <div class="recently-resto-picy">
                                                            <a href="restaurant_detail.html"><img
                                                                    src="{{asset('frontend/images/profile/view-1.jpg')}}" alt=""></a>
                                                        </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-12 pm-left">
                                                    <div class="visit-restaurants">
                                                        <div class="recently-resto-picy">
                                                            <a href="restaurant_detail.html"><img
                                                                    src="{{asset('frontend/images/profile/view-2.jpg')}}" alt=""></a>
                                                        </div>
                                                        <div class="recently-resto-dt">
                                                            <a href="restaurant_detail.html"><h4>Restaurant Name</h4></a>
                                                            <p><span><i class="fas fa-map-marker-alt"></i></span> Sydney,
                                                ...
                                                <div class="col-lg-6 col-md-6 col-12 pm-right">
                                                    <div class="visit-restaurants">
                                                        <div class="recently-resto-picy">
                                                            <a href="restaurant_detail.html"><img
                                                                    src="{{asset('frontend/images/profile/view-3.jpg')}}" alt=""></a>
                                                        </div>
                                                        <div class="recently-resto-dt">
                                                            <a href="restaurant_detail.html"><h4>Restaurant Name</h4></a>
                                                            <p><span><i class="fas fa-map-marker-alt"></i></span> Sydney,
                                                ...
                                                <div class="col-lg-6 col-md-6 col-12 pm-left">
                                                    <div class="visit-restaurants">
                                                        <div class="recently-resto-picy">
                                                            <a href="restaurant_detail.html"><img
                                                                    src="{{asset('frontend/images/profile/view-4.jpg')}}" alt=""></a>
                                                        </div>
                                                        <div class="recently-resto-dt">
                                                            <a href="restaurant_detail.html"><h4>Restaurant Name</h4></a>
                                                            <p><span><i class="fas fa-map-marker-alt"></i></span> Sydney,
...
<ins>Report</ins>
                                ...
                                <div class="main-comments">
                                    <div class="rating-1">
                                        ...
                                        <div class="comment-description">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur elementum
                                                leo sit amet volutpat porta. Integer tincidunt id enim eget suscipit. Aenean
                                                vitae mi at arcu pulvinar dictum. Donec pretium ipsum diam, vitae posuere
                                                nunc dapibus ut. Vivamus tempus et magna at elementum. Morbi sed turpis
                                                vitae elit pellentesque pharetra vel ut nisl.</p>
                                        </div>
                                    </div>
                                    <div class="like-comment-dt">
                                        <ul>
                                        ...
                                        <div class="select-images">
                                            <ul>
                                                <li class="image-select">
                                                    <img src="{{asset('frontend/images/restaurant-detail/add-1.jpg')}}" alt="">
                                                    <div class="post">
                                                        <a href="#" data-toggle="modal" data-target="#videoModal-2">
                                                            <div class="play-btn"><i class="fas fa-play"></i></div>
                                                        </a>
                                                    </div>
                                                    <div class="modal fade " id="videoModal-2" tabindex="-1" role="dialog"
                                                         aria-labelledby="videoModal" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                <div class="modal-body">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table  table-bordered">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="checkout-thumb-2">
                                                                    <a href="meal_detail.html">
                                                                        <img src="{{asset('frontend/images/checkout/thumb-1.jpg')}}"
                                                                             class="img-responsive" alt="thumb"
                                                                             title="thumb">
                                                                    </a>
                                                                </div>
                                                                <div class="name-dt">
                                                                    <a href="meal_detail.html"><h4>Hum Burgar</h4></a>
                                                                    <a href="restaurant_detail.html"><p>Restaurant Name</p>
                                                                    </a>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <button class="trace-btn btn-link" data-toggle="modal"
                                                                        data-target="#trace">Trace
                                                                </button>
                                                                <button class="invoice-btn btn-link"><i
                                                                        class="far fa-file-alt"></i></button>
                                                                <button class="trash-btn btn-link"><i
                                                                        class="far fa-trash-alt"></i></button>
                                                                <div class="modal fade" tabindex="-1" id="trace"
                                                                                ...
                                                                                <div class="container mb-1">
                                                                                    <div class="row no-gutters">
                                                                                        <div class="col-lg-8 col-md-6 col-12">
                                                                                            <div class="trace-map">
                                                                                                <img src="{{asset('frontend/images/profile/trace-map.jpg')}}"
                                                                                                     alt="">
                                                    ...
                                                    <table class="table  table-bordered">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="checkout-thumb-2">
                                                                    <a href="meal_detail.html">
                                                                        <img src="{{asset('frontend/images/profile/order-1.jpg')}}"
                                                                             class="img-responsive" alt="thumb"
                                                                             title="thumb">
                                                                    </a>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="checkout-thumb-2">
                                                                    <a href="meal_detail.html">
                                                                        <img src="{{asset('frontend/images/profile/order-2.jpg')}}"
                                                                             class="img-responsive" alt="thumb"
                                                                             title="thumb">
                                                                    </a>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="checkout-thumb-2">
                                                                    <a href="meal_detail.html">
                                                                        <img src="{{asset('frontend/images/profile/order-3.jpg')}}"
                                                                             class="img-responsive" alt="thumb"
                                                                             title="thumb">
                                                                    </a>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="checkout-thumb-2">
                                                                    <a href="meal_detail.html">
                                                                        <img src="{{asset('frontend/images/profile/order-4.jpg')}}"
                                                                             class="img-responsive" alt="thumb"
                                                                             title="thumb">
                                                                    </a>
                                                                </div>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-12">
                                                    ...
                                                    <form>
                                                        <div class="form-group">
                                                            <input type="text" class="video-form" id="cardNumber"
                                                                   name="cardNumber" placeholder="Card Number">
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="text" class="video-form" id="cardHolder"
                                                                   name="cardHolder" placeholder="Holder Name">
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 col-12 pm-left">
                                                                <div class="form-group">
                                                                    <input type="text" class="video-form" id="cardCvv"
                                                                           placeholder="Cvv">
                                                                </div>
                                                            </div>
                                ...
                                <div class="payments">
                                    <div class="payment-dt">
                                        ...
                                        <div class="wallet-btns">
                                            <button class="wallet-btn"><img src="{{asset('frontend/images/profile/payapl.png') }}" alt=""></button>
                                            <button class="wallet-btn"><img src="{{asset('frontend/images/profile/mobiwik.png') }}" alt="">
                                            </button>
                                            <button class="wallet-btn"><img src="{{asset('frontend/images/profile/paytm.png') }}" alt=""></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="suggestions full-width">
                            ...
                            <div class="suggestions-list">
                                <div class="pf-gallery">
                                    <ul>
                                        <li><a href="#" title=""><img src="{{asset('frontend/images/profile/right-1.jpg')}}" alt=""></a></li>
                                        <li><a href="#" title=""><img src="{{asset('frontend/images/profile/right-2.jpg')}}" alt=""></a></li>
                                        <li><a href="#" title=""><img src="{{asset('frontend/images/profile/right-3.jpg')}}" alt=""></a></li>
                                        <li><a href="#" title=""><img src="{{asset('frontend/images/profile/right-4.jpg')}}" alt=""></a></li>
                                        <li><a href="#" title=""><img src="{{asset('frontend/images/profile/right-5.jpg')}}" alt=""></a></li>
                                        <li><a href="#" title=""><img src="{{asset('frontend/images/profile/right-6.jpg')}}" alt=""></a></li>
                                        <li><a href="#" title=""><img src="{{asset('frontend/images/profile/right-7.jpg')}}" alt=""></a></li>
                                        <li><a href="#" title=""><img src="{{asset('frontend/images/profile/right-8.jpg')}}" alt=""></a></li>
                                        <li><a href="#" title=""><img src="{{asset('frontend/images/profile/right-9.jpg')}}" alt=""></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
